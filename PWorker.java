...
public class PWorker extends SwingWorker<String, Integer> {
	...
	PWorker(String fName, String newName) {
		...
		if (_fName.contains(".mp3")) {
			...
			_builder = new ProcessBuilder("/bin/bash", "-c", "file -b " + _fName + 
					" | grep Media && echo \"Successful\" || echo \"Invalid\" ; avconv -i " + _fName + " -vf \"drawtext=fontfile=/usr/share/fonts/truetype/ubuntu-font-family/Ubuntu-L.ttf: fontcolor=white: fontsize=30: text='Hello world': x=30: y=50\" testetstsetst.mp4");
