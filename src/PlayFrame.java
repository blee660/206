...
public class PlayFrame extends JFrame{
    ...
    private JButton _skipB = new JButton("◀◀ skip");
   	...
   	private JButton _addText = new JButton("Add Text");
    ...
    PlayFrame (String file) { 
    	...
    	_addText.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if(addTextFrame == null || addTextFrame.isVisible() == false){int DurationInSeconds;
...
class RewindWorker extends SwingWorker<Void,Void>{
	...
	protected Void doInBackground() throws Exception {
		// TODO Auto-generated method stub
		while(!isCancelled()){
			_mediaPlayer.getMediaPlayer().skip(-10);
		}
		return null;
	}
